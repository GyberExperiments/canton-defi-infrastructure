...
| **Blockchain** | Canton Network 3.4.10 / Splice 0.5.8 | Distributed ledger |
| **Database** | PostgreSQL 14-17 | Contract and state storage |
...
**Canton**: 3.4.10 | **Splice**: 0.5.8 | **Protocol**: 34
